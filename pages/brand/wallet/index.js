  ...
  return (
    <>
      <main className="bg-main-bg px-4 sm:px-6 lg:px-[60px]">
        <div className="py-6">
          <div className="mx-auto sm:flex md:flex justify-between ">
            <div>
            ...
            {/* <div className="flex mt-4 md:mt-0 min-w-[197px] items-start space-x-[12px]">
              <button className="bg-white whitespace-nowrap flex items-center shadow-dark10 leading-[22px] text-violet600 px-[15px] py-1 text-[15px] font-medium rounded">
                <img
              ...
              <button
                ...
                className="bg-violet600 whitespace-nowrap flex items-center shadow-dark10 leading-[22px] text-white px-[15px] py-1 text-[15px] font-medium rounded"
              >
                Top up
              </button>
            </div> */}
