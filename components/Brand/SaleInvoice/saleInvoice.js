import React,
{
    Fragment, useState, Component, useEffect
} from "react";
import {
    Disclosure,
    Dialog,
...
} from "../../../Redux/action/stock";
import {
    resetToast, showToast
} from "../../../Redux/action/toast";
...
export default function SaleInvoice({ profileView, setProfileView, userDetail
}) {
    ...
    return (
        <div>
            <div className="">
                ...
                <Transition.Root show={profileView
                } as={Fragment
                }>
                                                            ...
                                                            <div className="flex justify-between mb-9">
                                                                ...
                                                                <div className="">
                                                                    ...
                                                                    <div className="flex gap-[33px] mb-4">
                                                                        ...
                                                                        <input type="date" className=" w-full min-w-[70px] text-center text-[13px] font-medium leading-5 text-gray700"
                                                                            defaultValue={date} />
                                                                    </div>
                                                                        ...
                                                                        <div className="overflow-hidden">
                                                                            <table className="min-w-full border text-center">
                                                                                <thead className="border-b">
                                                                                    <tr>
                                                                                        <th scope="col" className="text-sm font-medium text-gray-900 py-4 border-r">
                                                                                            #
                                                                                        </th>
                                                                                        <th colspan="2" scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 border-r">
                                                                                            ITEM
                                                                                        </th>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr className="border-b">
                                                                                        ...
                                                                                        <td rowspan="1" className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">
                                                                                            Mark
                                                                                        </td>
                                                                                        ...
                                                                                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">
                                                                                            Otto
                                                                                        </td><td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">
                                                                                            Otto
                                                                                        </td><td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">
                                                                                            Otto
                                                                                        </td><td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">
                                                                                    ...
                                                                                    <tr className="bg-white border-b">
                                                                                        ...
                                                                                        <td colspan="2" className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center border-r">
                                                                                            Larry the Bird
                                                                                        </td>
                                                                                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                                            @twitter
